          ...
          {step === 'review' && (
            <div className="space-y-3">
              <div className={card + ' p-3.5 space-y-1 text-sm'}>
                ...
                <div className="pt-1"><Badge s={effectiveExamStatus({ startDate: form.startDate ? fromDatetimeLocalIST(form.startDate) : (editId ? (exams.find(e => e.id === editId)?.startDate || new Date().toISOString()) : new Date().toISOString()), durationMinutes: form.durationMinutes })} /></div>
